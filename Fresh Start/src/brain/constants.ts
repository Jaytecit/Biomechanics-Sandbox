...
/**
 * Observation vector length (D7 contact/terrain pack).
 * 0–5: v1 body stats · 6 foot contact · 7 foot clearance · 8 terrain grade (stub)
 * · 9 head height (marked head Y / HEIGHT_SCALE)
 */
export const OBS_COUNT = 10;
